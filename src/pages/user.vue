      ...
      <div class="wrapper">
        <div class="wrapper_centent">
          <div class="wrapper_logo">
            <img src="../assets/images/home_user.png" alt="" style="width: 100%">
        ...
        <div class="wrapper_from">
          ...
          <div class="wrapper_from_meun">
            ...
            <el-input v-model="editForm.name" class="ruleForm_input" placeholder="请设置你的密码"></el-input>
          </div>
          <div class="ruleForm_footer">
            <div class="ruleForm_dect">请注意，一旦注销账户，您的所有用户数据将被清除</div>
            <div style="display: flex;">
              <div class="ruleForm_btn" style="margin-right: 10px"><img src="../assets/images/icon_01.png" alt="" >注销账号</div>
              <div class="ruleForm_btn"><img src="../assets/images/icon_02.png" alt="">保存信息</div>
            </div>
