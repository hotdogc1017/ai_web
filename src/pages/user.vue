    ...
    <div class="user_centainr">
      ...
      <div class="wrapper">
        <div class="wrapper_centent">
          ...
          <div class="wrapper_info">
            <div class="wrapper_info_view">
              <div class="wrapper_info_text">
                昵称：<span class="wrapper_info_name">{{
                  userInfo.username
                }}</span
                ><span class="wrapper_info_dect">修改</span>
              </div>
            ...
            <div class="wrapper_info_view">
              <div class="wrapper_info_text">
                ID：<span class="wrapper_info_name">{{ userInfo.uid }}</span>
              </div>
              <div class="wrapper_info_text">
                会员：
                <el-button type="primary" size="mini" class="wrapper_info_btn"
                  >一级会员</el-button
                >
                <el-button type="info" size="mini" class="wrapper_info_btn1"
                  >开通会员</el-button
                >
              </div>
            </div>
        ...
        <div class="wrapper_from">
          ...
          <div class="wrapper_from_title" style="margin-top: 30px">
            安全设置
          </div>
          <div class="wrapper_from_meun">
          ...
          <div class="ruleForm_footer">
            <div class="ruleForm_dect">
              请注意，一旦注销账户，您的所有用户数据将被清除
            </div>
            <div style="display: flex">
              ...
              >
                <img src="../assets/images/icon_01.png" alt="" />注销账号
              </div>
              <div class="ruleForm_btn" @click="handleSubmitEditForm">
                <img src="../assets/images/icon_02.png" alt="" />保存信息
              </div>
            </div>
          </div>
        </div>
...
import userEdit from "@/assets/images/user_edit.png";
export default {
  name: "user",
  components: { vHead },
  data() {
